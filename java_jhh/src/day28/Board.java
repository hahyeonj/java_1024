...
public class Board implements Serializable{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -622941918289228490L;
	//Serializable 이 있어야 write read object를 통해 읽어오기 가능
	...
	public Board(int num) {
		this.num = num;
		//실제 조회가 아니라 검색이나 삭제할떄 이용하기 위해 만듬
	...
	public String toString() {
		return num + "." + category + " | " + getRegDate() + " | "
				+ views + " | " + writer + " | ";
