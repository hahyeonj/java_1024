...
public class StringEx01 {
	...
	public static void main(String[] args) {
		 ...
		 * String Buffer 클래스는 문자열의 값 수정할 수 있다.
		 * StringBuilder클래스는 StringBuffer와 동일하다
		 ...
		 * 		첫번째로 만나는 문자열/문자의 시작번지
		 * lastIndexIf(문자 또는 문자열 : 해당 문자열/문자를 마지막 번지부터 탐색하여 
		...
		*/
		...
		/* cahrAt(번지) : 문자열에서 해당 번지에 있는 문자열을 반환
		 * */
		String str4 = "Hello";
		...
		/* trim() : 시작 문자 앞에있는 공백을 제거하고 마지막 문자뒤에 있는 공백을 제거함
		 * */
		String str5 = "\n\n          \t안녕 하세요.\n\n";
