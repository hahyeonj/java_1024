 ...
 * 자동차
 * -타이어 수, 차종, 색상, 번호, 전원(시동), 속력, 기어, 제조사
 * - 전원 켜기/끄기, 기어 변경,
 * 타이어
 * -제조사, 크기, 종류(스노우/ 일반), 상태
 * -
...
class KiaCar extends Car{
	...
	public KiaCar(int tireCount, String type, int color, String carNum, String company) {
		super(tireCount, type, color, carNum, "기아");
		this.company = "기아";
	}
	public void kia() {
		System.out.println("기아입니다.");
	}
...
class HyundaiCar extends Car{
	...
	public HyundaiCar(int tireCount, String type, int color, String carNum, String company) {
		super(tireCount, type, color, carNum, "현대");
		this.company = "현대";
	}
	public void hyundai() {
		System.out.println("현대입니다.");
	}
}
