...
public class BaseballManager {
	...
	public static void addRecord(Record[] records, int tryCount) {
	...
	public static int getMaxRecordRank(Record[] records) {
		int rank = 0;
		for(Record record : records) {
			if(record != null) {
				rank++;
	...
	public static int getMaxRecordCount(Record[] records) {
		int count = 9999999;
		for(Record record : records) {
			if(record != null) {
